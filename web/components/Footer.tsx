...
const Footer = () => {
    return (<>
        <footer className="flex flex-col sm:flex-row space-y-5 sm:space-y-0 p-5 sm:p-10 sm:justify-center sm:space-x-20 relative z-20 text-sm">
            <section className="flex flex-col space-y-3 items-center bg-white bg-opacity-95 p-5 shadow w-full sm:w-1/2 md:w-1/3 xl:w-1/4">
                ...
                <nav>
                    <ul className="flex space-x-3">
                        <li>
                            <Link href="/impressum"><a className="underline">
                                Impressum
                            </a></Link>
                        </li>
                        <li>
                            <Link href="/datenschutz"><a className="underline">
                                Datenschutz
                            </a></Link>
                        </li>
                    </ul>
            ...
            <section className="flex flex-col text-center space-y-5 bg-white bg-opacity-95 p-5 shadow sm:justify-center w-full sm:w-1/2 md:w-1/3 xl:w-1/4">
                ...
                <div>
                    ...
                    <ul className="flex space-x-5 justify-center">
                        <li>
                            <a href="https://de-de.facebook.com/konzentration.mwerner/" target="_blank" rel="noopener noreferrer">
                                <FaFacebook color="#4267B2" size={30} />
                            </a>
                        </li>

                        <li>
                            <a href="https://www.instagram.com/mkt_muenchen_ost/" target="_blank" rel="noopener noreferrer">
                                <FaInstagram color="#833AB4" size={30} />
                            </a>
                        </li>

                        <li>
                            <a href="https://api.whatsapp.com/send?phone=4917614300141" target="_blank" rel="noopener noreferrer">
                                <FaWhatsapp color="#075e54" size={30} />
                            </a>
                        </li>

                        <li>
                            <a href="https://www.google.com/search?client=firefox-b-d&q=mkt+m%C3%BCnchen+ost" target="_blank" rel="noopener noreferrer">
