                ...
                <div className="flex flex-col md:flex-row md:space-x-5 lg:space-x-8 mx-auto">
                    <div className="mb-8 md:mb-0">
                        <AccordionSidebar
                            ...
                            entries={accordionEntries}></AccordionSidebar>
                    </div>
                        <motion.article
                        ...
                        >
                            <h1
                                ...
                                className="text-5xl mb- font-semibold lette">
                                {currentService.title}
                            </h1>
                            <PortableText 
                                className="prose"
                                blocks={currentService.description.text}></PortableText>
                        </motion.article>
                </div>
            </section>
        </Layout>
...
export const getStaticProps: GetStaticProps = async ({params, preview = false}: any) => {
    const currentService = await getClient(preview).fetch(groq`
