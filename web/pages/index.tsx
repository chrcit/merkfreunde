...
const Home: NextPage = ({serviceExcerpts}: any) => {
  return (<>
          ...
          <div className="flex flex-col md:flex-row md:items-center space-y-10 md:space-y-0 md:space-x-20">
              ...
              <motion.div className="w-8/12 space-y-3">
                <p className="text-lg">
                  ...
                  mein Name ist Manuela Werner und ich bin zertifizierte Trainerin für das Marburger Konzentrationstraining, sowie studierter Lerncoach (ILS 1,0).

                  Im Jahr 1994 und 1997 kamen unsere Söhne auf die Welt und 2004 unsere Tochter. In den ersten Jahren engagierte ich mich gleichzeitig ehrenamtlich in Waldtrudering, München. Durch diese Arbeit bemerkte ich schnell mein gutes Gespür, die Bedürfnisse von Kindern wahrzunehmen. Sie zu bestärken und auf ihrem Weg zu begleiten wurde zu einer Herzensangelegenheit.
                </p>
        ...
        <section className="max-w-5xl mx-auto pb-20">
          ...
          <div className="flex flex-col md:flex-row md:items-center space-y-10 md:space-y-0 md:space-x-5">
              ...
              <div className="w-full md:w-1/2 space-y-10">
                <div>
                  <h3 className="text-2xl text-center mb-5">Kontaktieren Sie Uns</h3>
                  <p className="text-center">
                    Unsere Telefonsprechstunde:<br/>
              ...
              <div className="w-full md:w-1/2">
                <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d170488.18578010958!2d11.685056!3d48.112591!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x479de030162b14ab%3A0x6f73ff1599e6b8f9!2sMarburger%20Konzentrationstraining%20M%C3%BCnchen%20Ost!5e0!3m2!1sen!2sus!4v1632331430111!5m2!1sen!2sus"className="w-full"  height="450" loading="lazy"></iframe>
              </div>
          </div>
        </section>
